const GOAL_CATEGORIES = {
  ...
  'tissue-research': {
    ...
    products: ['gh-stack', 'sermorelin', 'bpc-157', 'tb-500', 'recovery-stack', 'igf-1-lr3'],
  },
  'matrix-research': {
    id: 'matrix-research',
  ...
  'cognitive-research': {
    ...
    label: 'Cognitive Research Compounds',
    subtitle: 'Neuropeptide signaling models',
    products: ['semax-selank', 'pt-141'],
  },
  'longevity-research': {
    id: 'longevity-research',
    label: 'Longevity Research Compounds',
...
const GOAL_ALIASES = {
  ...
  'endocrine-research': 'tissue-research',
};
...
const PRODUCTS = {
  semaglutide: vialProduct({
    ...
    description: 'Semaglutide (GLP-1 analog) — research-grade lyophilized vial for in-vitro metabolic pathway studies.',
  ...
  tesamorelin: vialProduct({
    ...
    categories: ['metabolic-research'], color: '#0d9488',
  ...
  'gh-stack': vialProduct({
    id: 'gh-stack', name: 'CJC-1295 + Ipamorelin Pairing', price: 93, cogs: 9,
    tagline: 'Commonly studied pairing — two lyophilized vials',
    description: 'Commonly studied pairing: CJC-1295 and Ipamorelin — separate lyophilized vials with individual COAs for in-vitro research.',
    categories: ['tissue-research'], color: '#a855f7', isBundle: true, featured: true,
  ...
  sermorelin: vialProduct({
    ...
    categories: ['tissue-research'], color: '#ec4899',
    currentLot: 'RC-SER26-0407',
  }),
  'bpc-157': vialProduct({
    id: 'bpc-157', name: 'BPC-157', price: 99.5, cogs: 4.6,
    tagline: 'Pentadecapeptide — lyophilized research vial',
    description: 'BPC-157 (Pentadecapeptide) — lyophilized vial for in-vitro research. Sequence GEPPPGKPADDAGLV.',
  ...
  'tb-500': vialProduct({
    ...
    tagline: 'Synthetic heptapeptide (LKKTETQ) — lyophilized research vial',
    description: 'TB-500 — synthetic heptapeptide (LKKTETQ) supplied lyophilized for in-vitro laboratory research.',
  ...
  'recovery-stack': vialProduct({
    id: 'recovery-stack', name: 'BPC-157 + TB-500 Pairing', price: 124.5, cogs: 10.4,
    tagline: 'Commonly studied pairing — two lyophilized vials',
    description: 'Commonly studied pairing: BPC-157 and TB-500 — separate lyophilized vials with individual COAs for in-vitro research.',
  ...
  'igf-1-lr3': vialProduct({
    ...
    categories: ['tissue-research'], color: '#7c3aed',
    currentLot: 'RC-IGF26-0409',
  }),
  'ghk-cu': vialProduct({
    id: 'ghk-cu', name: 'GHK-Cu', price: 99.5, cogs: 4,
    tagline: 'Copper(II)-GHK tripeptide — lyophilized research vial',
    description: 'GHK-Cu — copper(II) complex of the GHK tripeptide supplied lyophilized for in-vitro matrix and collagen assay research.',
